...
<?php if(!request()->cookie('cookie_consent')): ?>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-cream/80 leading-relaxed">
                    ...
                    <a href="<?php echo e(route('cookies.show')); ?>" class="underline hover:text-accent">notre politique cookies</a>
                    pour en savoir plus.
                </p>
            </div>

            <div class="flex gap-3 w-full md:w-auto shrink-0">
                <form action="<?php echo e(route('cookies.store')); ?>" method="POST" class="flex-1 md:flex-none">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\simo-\Desktop\projet finale\resources\views/partials/cookie-banner.blade.php ENDPATH**/ ?>