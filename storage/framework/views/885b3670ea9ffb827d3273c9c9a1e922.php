<?php $__env->startSection('title', 'Politique des cookies — TEE/SHOP'); ?>
...
<section class="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <p class="text-ink/60 mb-10">Dernière mise à jour : <?php echo e(now()->format('d/m/Y')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\simo-\Desktop\projet finale\resources\views/cookies/policy.blade.php ENDPATH**/ ?>