...
<body class="bg-gray-50 min-h-screen flex">
    ...
    <aside class="w-64 bg-ink text-cream min-h-screen sticky top-0 flex flex-col" style="background: #0f0f0f;">
        ...
        <div class="px-4 py-4 border-b border-white/5">
            <div class="flex items-center gap-3 bg-white/5 rounded-xl px-3 py-2.5">
                ...
                <div class="min-w-0">
                    <p class="text-xs font-semibold text-white truncate"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->name); ?></p>
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-accent text-white font-medium' : 'text-white/60 hover:bg-white/8 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all <?php echo e(request()->routeIs('admin.products.*') ? 'bg-accent text-white font-medium' : 'text-white/60 hover:bg-white/8 hover:text-white'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/>
                </svg>
                Produits
                <?php $productCount = \App\Models\Product::count(); ?>
                <?php if($productCount): ?>
                    <span class="ml-auto text-xs bg-white/10 text-white/60 px-2 py-0.5 rounded-full"><?php echo e($productCount); ?></span>
                <?php endif; ?>
            </a>

            <a href="<?php echo e(route('admin.categories.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-accent text-white font-medium' : 'text-white/60 hover:bg-white/8 hover:text-white'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-accent text-white font-medium' : 'text-white/60 hover:bg-white/8 hover:text-white'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <?php if($pendingOrders): ?>
                    <span class="ml-auto text-xs bg-accent text-white px-2 py-0.5 rounded-full"><?php echo e($pendingOrders); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.seo')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all <?php echo e(request()->routeIs('admin.seo*') ? 'bg-accent text-white font-medium' : 'text-white/60 hover:bg-white/8 hover:text-white'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <main class="flex-1 min-h-screen">
        ...
        <div class="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between sticky top-0 z-10">
            <div>
                <h2 class="text-sm font-semibold text-gray-800"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h2>
...
</html><?php /**PATH C:\Users\simo-\Desktop\projet finale\resources\views/layouts/admin.blade.php ENDPATH**/ ?>