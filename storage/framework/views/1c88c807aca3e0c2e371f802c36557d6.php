...
<?php $__env->startSection('title', 'CGV — TEE/SHOP'); ?>
<?php $__env->startSection('eyebrow', 'Informations légales'); ?>
<?php $__env->startSection('heading', 'Conditions générales de vente'); ?>
...
<p>Le traitement des données personnelles est régi par notre <a href="<?php echo e(route('pages.show', 'confidentialite')); ?>" class="underline">politique de confidentialité</a>.</p>
...
<?php echo $__env->make('layouts.page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\simo-\Desktop\projet finale\resources\views/pages/cgv.blade.php ENDPATH**/ ?>